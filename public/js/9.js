...
Component.options.__file = "resources/pages/NewsTag.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7883d9d4", Component.options)
  } else {
    hotAPI.reload("data-v-7883d9d4", Component.options)
  }
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("block-news", { attrs: { tag: this.$route.params.tag, isTag: true } }),
      _vm._v(" "),
      _c("block-footer")
    ],
    1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7883d9d4", module.exports)
  }
}
